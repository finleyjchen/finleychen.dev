  ...
  return (
    <Layout>
      <section className='grid-2 hero-bio'>
        <h2 className='measure'>Relentless learning &amp; improvement.</h2>
        <div>
      ...
      <section className='grid-2'>
        ...
        <blockquote className="testimonial">
          ...
          <cite className="testimonial-author">Matt Miller, <em>Paso Robles Ironworks</em></cite>
        </blockquote>
        <blockquote className="testimonial">
          ...
          <cite className="testimonial-author">Nancy Fox, <em>Skinnykitchen</em></cite>
        </blockquote>
        </div>
      </section>
     <section className='grid-2'>
